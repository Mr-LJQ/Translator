...
var Agent = /*#__PURE__*/_createClass(function Agent() {
  var _this = this;
  ...
  _defineProperty(this, "install", function () {
    ...
    (_this$messenger = _this.messenger) === null || _this$messenger === void 0 ? void 0 : _this$messenger.install();
  ...
  _defineProperty(this, "uninstall", function () {
    ...
    (_this$messenger2 = _this.messenger) === null || _this$messenger2 === void 0 ? void 0 : _this$messenger2.uninstall();
  ...
  _defineProperty(this, "isVisible", function () {
    ...
    return (_this$mask = _this.mask) === null || _this$mask === void 0 ? void 0 : _this$mask.isConnected;
  });

  _defineProperty(this, "onClickToggle", function () {
    _this.hiddenTranslationView();

    _this.postMessage(_configuration__WEBPACK_IMPORTED_MODULE_0__.Command.PauseAudio);
  });

  _defineProperty(this, "hiddenTranslationView", function () {
    var _this$mask2, _this$configMask;

    (_this$mask2 = _this.mask) === null || _this$mask2 === void 0 ? void 0 : _this$mask2.remove();
    (_this$configMask = _this.configMask) === null || _this$configMask === void 0 ? void 0 : _this$configMask.remove(); //不能够使用 hidden=true 的形式，因为那样会导致 translationContainer 在渲染树中删除
    //这样会导致 translationPage 更新时，不能够实时获取内部元素的高度

    _this.translationContainer.style.visibility = "";

    _this.configContainer.classList.add("hidden");
  });

  _defineProperty(this, "showTranslation", function (data) {
    var translatedData = data.translatedData;
    var point = data.point;

    _this.postMessage(_configuration__WEBPACK_IMPORTED_MODULE_0__.Command.ShowTranslation, translatedData, function () {
      //UI更新后再展示iframe,避免闪烁
      _this.showUI(point);
    });
  });

  _defineProperty(this, "showUI", function (point) {
    var rect = _this.translationContainer.getBoundingClientRect();

    var width = rect.width;
    var height = rect.height;
    var left = (point === null || point === void 0 ? void 0 : point.x) || rect.left;
    var top = (point === null || point === void 0 ? void 0 : point.y) || rect.top; //用于判断是否超出视口
    ...
    _this.mask.isConnected && document.body.append(_this.mask);
    _this.translationContainer.style.cssText = "\n      visibility:visible;\n      left:".concat(left, "px;\n      top:").concat(top, "px;\n    ");
  });

  //建立通信
  this.messenger = new _utils__WEBPACK_IMPORTED_MODULE_1__.Messenger({
    self: window
  });
  ...
  iframe.addEventListener("load", function () {
    ...
    _this.onMessage(_configuration__WEBPACK_IMPORTED_MODULE_0__.Command.HistoryIndex, function (_ref) {
    ...
    configContainer.addEventListener("input", function (event) {
      ...
      if (input.name === openSelection) {
        ...
        _this.postMessage(_configuration__WEBPACK_IMPORTED_MODULE_0__.Command.OpenSelection, isOpen);

        (0,_extensions_api__WEBPACK_IMPORTED_MODULE_2__.setStorage)({
      ...
      if (input.name === hiddenChinese) {
        ...
        _this.postMessage(_configuration__WEBPACK_IMPORTED_MODULE_0__.Command.HiddenChinese, hidden);
    ...
    container.addEventListener("click", function (event) {
      ...
      if (target === backButton) {
        _this.messenger.postMessage(_configuration__WEBPACK_IMPORTED_MODULE_0__.Command.BackHistory);
      }

      if (target === forwardButton) {
        _this.messenger.postMessage(_configuration__WEBPACK_IMPORTED_MODULE_0__.Command.ForwardHistory);
      }
    }); //拖拽
    ...
    (0,_extensions_api__WEBPACK_IMPORTED_MODULE_2__.getStorageByArray)(["openSelection", "hiddenChinese"], function (item) {
      _this.postMessage(_configuration__WEBPACK_IMPORTED_MODULE_0__.Command.OpenSelection, !!item.openSelection);

      _this.postMessage(_configuration__WEBPACK_IMPORTED_MODULE_0__.Command.HiddenChinese, !!item.hiddenChinese);
    });
  }); //此处的translationPage.html需要参考所生成文件的具体名称

  iframe.src = (0,_extensions_api__WEBPACK_IMPORTED_MODULE_2__.getURL)("translationPage.html");
  /**
...
function createTranslationView() {
  var width = 400;
  var height = 300;
  var wrapper = document.createElement("div"); //创建幽灵节点
  ...
  var configContainer = document.createElement("form");
  (0,_extensions_api__WEBPACK_IMPORTED_MODULE_2__.getStorageByArray)(["openSelection", "hiddenChinese"], function (item) {
    configContainer.innerHTML = "\n      <label >\u542F\u7528\u9009\u8BCD\u7FFB\u8BD1<input type=\"checkbox\" name=\"".concat(openSelection, "\" ").concat(item.openSelection ? "checked" : "", "/></label>\n      <label >\u9690\u85CF\u4E2D\u6587\u7FFB\u8BD1<input type=\"checkbox\" name=\"").concat(hiddenChinese, "\" ").concat(item.hiddenChinese ? "checked" : "", "/></label>");
  });
...
/* harmony import */ var _Agent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Agent */ "./src/content-script/Agent.ts");
...
var searchBox = new _user_operation__WEBPACK_IMPORTED_MODULE_0__.SearchBox(translateAndShowSearchText);
var selectionListener = new _user_operation__WEBPACK_IMPORTED_MODULE_0__.SelectionListener(translateAndShowText);
var hotKeyListener = new _user_operation__WEBPACK_IMPORTED_MODULE_0__.HotKeyListener(translateAndShowText, getClientPoint);
cursorListener.install();
searchBox.install(); //监听iframe传递的指令并进行处理

var agent = new _Agent__WEBPACK_IMPORTED_MODULE_1__.Agent();
agent.onMessage(_configuration__WEBPACK_IMPORTED_MODULE_2__.Command.AddNote, /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (data, sendResponse) {
    var response = yield (0,_extensions_api__WEBPACK_IMPORTED_MODULE_3__.postBackend)(_configuration__WEBPACK_IMPORTED_MODULE_2__.Command.AddNote, data);
...
agent.onMessage(_configuration__WEBPACK_IMPORTED_MODULE_2__.Command.RelearnNote, /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(function* (data, sendResponse) {
    var response = yield (0,_extensions_api__WEBPACK_IMPORTED_MODULE_3__.postBackend)(_configuration__WEBPACK_IMPORTED_MODULE_2__.Command.RelearnNote, data);
    sendResponse(response);
  });
...
agent.onMessage(_configuration__WEBPACK_IMPORTED_MODULE_2__.Command.TranslateText, function (data) {
...
function showInjectScriptTranslationText(data) {
...
function _translateAndShowText() {
  _translateAndShowText = _asyncToGenerator(function* (text) {
    //如果正在展示翻译，则不能够通过selection进行翻译。
    //这主要是避免热键查询的情况
    if (agent.isVisible()) return; //过滤掉非英文

    var result = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.validateText)(text);
    if (!result) return;
    var translatedData = yield (0,_extensions_api__WEBPACK_IMPORTED_MODULE_3__.postBackend)(_configuration__WEBPACK_IMPORTED_MODULE_2__.Command.TranslateText, text);
...
function _translateAndShowSearchText() {
  _translateAndShowSearchText = _asyncToGenerator(function* (text) {
    var translatedData = yield (0,_extensions_api__WEBPACK_IMPORTED_MODULE_3__.postBackend)(_configuration__WEBPACK_IMPORTED_MODULE_2__.Command.TranslateText, text);
    var point = getClientPoint();
    agent.showTranslation({
      translatedData: translatedData,
...
function _translateAndShowIframeText() {
  _translateAndShowIframeText = _asyncToGenerator(function* (text) {
    //过滤掉非英文
    var result = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.validateText)(text);
    if (!result) return;
    var translatedData = yield (0,_extensions_api__WEBPACK_IMPORTED_MODULE_3__.postBackend)(_configuration__WEBPACK_IMPORTED_MODULE_2__.Command.TranslateText, text);
...
(0,_extensions_api__WEBPACK_IMPORTED_MODULE_3__.onMessage)( /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(function* (_ref3) {
    var command = _ref3.command,
        data = _ref3.data;
    if (command === _configuration__WEBPACK_IMPORTED_MODULE_2__.Command.ShowIframe) agent.showUI(getClientPoint());
    if (command === _configuration__WEBPACK_IMPORTED_MODULE_2__.Command.OpenSearchBox) searchBox.openSearchBox();
    if (command === _configuration__WEBPACK_IMPORTED_MODULE_2__.Command.ShowInjectTranslation) showInjectScriptTranslationText(data);
  });
